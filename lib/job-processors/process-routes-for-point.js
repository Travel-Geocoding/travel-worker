    ...
    .then((firstLocationResult) => {
      ...
      firstLocationResult.locations
        ...
        .forEach((location) => {
          ...
          const sortedLocationsResult = calculationOfSortedRoutes({
            startLocation,
...
function calculationOfSortedRoutes({ startLocation, newLocation, existingClosestRouteArray }) {
